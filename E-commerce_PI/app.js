...
//busqueda por nombre a terminar
/*
 searchInput.addEventListener("input", e =>{
   const value = e.target.value.toLowerCase();
   console.log(productos);
   productos.forEach(products => {
     const isVisible = products.title.includes(value);
...
class UI {
  displayProducts(products) {
    ...
    productos = products.map(product => {
      result += `
        <article class="product" id="productList">
   ...
   `;
   return{title: product.title, price: product.price, image: product.image}
    });
